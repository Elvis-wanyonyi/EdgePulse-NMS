...
import com.wolfcode.MikrotikNetwork.dto.PackagePlanDto;
...
public class PackageController {
    ...
    @PutMapping("edit/{id}")
    public ResponseEntity<String> editHotspotPlan(@PathVariable Long id, @Valid @RequestBody PackagePlanDto packagePlanDto) throws MikrotikApiException {
        mikrotikService.editHotspotPlan(id, packagePlanDto);
        return ResponseEntity.ok("Successfully updated hotspot plan");
    }

    @DeleteMapping("{id}")
    public ResponseEntity<String> deleteHotspotPlan(@PathVariable Long id) throws MikrotikApiException {
